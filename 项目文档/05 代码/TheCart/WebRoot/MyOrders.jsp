    ...
    <div class="person">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b><font color="#CC9999">我的订单</font></b></div>
     <div class="soma">
    			...
    			<center>
    				<table>
    					...
    					<%
    						...
    						pageModel = DAOfactory.getIt_OrderInstance().OrderSelectByUser(id, 5, u.getUsername());
    						pageModel.setTotalNum(DAOfactory.getIt_OrderInstance().UserNewOrderNum(u.getUsername()));
    	...
    	<div style="width:60%;height:100%;lineheight:100%;margin:auto;">
    		<ul class="items">
    			<li class="item"><span><a id="first" class="number" href="MyOrders.jsp?id=<%=pageModel.getPageNo()-1 %>">上一页</a></span></li>
    			<%
    				for(int i =0; i < pageModel.getTotalPage() && i<5;i++){
    			 %>
    			<li class="item pre"><span><a class="number" id="<%=i+1 %>" href="MyOrders.jsp?id=<%=i+1 %>"><%=i+1 %></a></span></li>
    			<%} %>
    			<li class="item"><span><a id="next" class="number" href="MyOrders.jsp?id=<%=pageModel.getPageNo()+1 %>">下一页</a></span></li>
