...
<html>
  <head>
    ...
    <title>My JSP 'PetDelete.jsp' starting page</title>
  ...
  <body>
    ...
    <div class="infor">
    	<center>
    		<form action="servlet/PetManager?action=add" method="post" enctype="multipart/form-data">
    			<table id="im">
    				<tr>
    					<td>宠物编号</td>
    				...
    				<tr>
    					<td>拉丁名</td>
    					<td><input type="text" name="csp" ></td>
    				</tr>
    				<tr>
    					<td>品种</td>
    					<td><input type="text" name="ckind" ></td>
    				</tr>
    				<tr>
    					<td>简介</td>
    					<td><textarea cols="40" rows="10" name="cdescript"></textarea></td>
    				</tr>
    				<tr>
    					<td>主页图片更改</td>
