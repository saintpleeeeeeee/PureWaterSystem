    ...
    <div class="person">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b><font color="#CC9999">订单管理</font></b>
     ...
     <div class="infor">
    	<center>
    		<table>
    			...
    			<%
    				...
    				pageModel = DAOfactory.getIt_OrderInstance().OrderSelectNew(id, 5,keywords);
    				pageModel.setTotalNum(DAOfactory.getIt_OrderInstance().NewOrdersNum());
    			...
    			<tr>
    				...
    				<td><%=o.getBuyTime() %></td>
    				<td><%=o.getMcstate() %></td>
    				<td><a href="servlet/OrderMUserlet?action=confirm&oid=<%=o.getOid()%> " onclick="delefm()">确认</a></td>
    			</tr>
    			<%
    				}
    			 %>
    	...
    	<div style="width:60%;height:100%;lineheight:100%;margin:auto;">
    		<ul class="items">
    			<li class="item"><span><a id="first" class="number" href="Mangerorder.jsp?id=<%=pageModel.getPageNo()-1 %>">上一页</a></span></li>
    			<%
    				for(int i =0; i < pageModel.getTotalPage() && i<5;i++){
    			 %>
    			<li class="item pre"><span><a class="number" id="<%=i+1 %>" href="Mangerorder.jsp?id=<%=i+1 %>"><%=i+1 %></a></span></li>
    			<%} %>
    			<li class="item"><span><a id="next" class="number" href="Mangerorder.jsp?id=<%=pageModel.getPageNo()+1 %>">下一页</a></span></li>
